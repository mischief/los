...
{
	unsigned val;
	__asm__ __volatile__("movl %%dr0,%0" : "=r" (val));
	return val;
}
...
{
	unsigned val;
	__asm__ __volatile__("movl %%dr1,%0" : "=r" (val));
	return val;
}
...
{
	unsigned val;
	__asm__ __volatile__("movl %%dr2,%0" : "=r" (val));
	return val;
}
...
{
	unsigned val;
	__asm__ __volatile__("movl %%dr3,%0" : "=r" (val));
	return val;
}
...
{
	unsigned val;
	__asm__ __volatile__("movl %%dr6,%0" : "=r" (val));
	return val;
}
...
{
	unsigned val;
	__asm__ __volatile__("movl %%dr7,%0" : "=r" (val));
	return val;
}

OSKIT_INLINE void set_dr0(unsigned val)
{
	__asm__ __volatile__("movl %0,%%dr0" : : "r" (val));
}
...
OSKIT_INLINE void set_dr1(unsigned val)
{
	__asm__ __volatile__("movl %0,%%dr1" : : "r" (val));
}

OSKIT_INLINE void set_dr2(unsigned val)
{
	__asm__ __volatile__("movl %0,%%dr2" : : "r" (val));
}

OSKIT_INLINE void set_dr3(unsigned val)
{
	__asm__ __volatile__("movl %0,%%dr3" : : "r" (val));
}

OSKIT_INLINE void set_dr6(unsigned val)
{
	__asm__ __volatile__("movl %0,%%dr6" : : "r" (val));
}

OSKIT_INLINE void set_dr7(unsigned val)
{
	__asm__ __volatile__("movl %0,%%dr7" : : "r" (val));
}
