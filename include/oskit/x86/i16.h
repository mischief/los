...
#define CODE16 __asm__(CODE16_STRING);
 ...
 */
#define i16_switch_to_32bit(cs32) __asm__ __volatile__("ljmp	%0,$1f;" \
		".code32;" \
		"1:" : : "i" (cs32));
#define switch_to_16bit(cs16) __asm__ __volatile__("ljmp	%0,$1f;" \
		CODE16_STRING ";" \
		"1:" : : "i" (cs16));
