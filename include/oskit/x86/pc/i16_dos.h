...
OSKIT_INLINE unsigned short i16_dos_version(void)
{
	...
	__asm__ __volatile__("int $0x21" : "=a" (dos_version_swapped) : "a" (0x3000));
	return (dos_version_swapped >> 8) | (dos_version_swapped << 8);
}

OSKIT_INLINE void i16_dos_putchar(int c)
{
	__asm__ __volatile__("int $0x21" : : "a" (0x0200), "d" (c));
}

OSKIT_INLINE void i16_dos_exit(int rc)
{
	__asm__ __volatile__("int $0x21" : : "a" (0x4c00 | (rc & 0xff)));
}
...
OSKIT_INLINE void i16_dos_get_int_vec(int vecnum, struct far_pointer_16 *out_vec)
{
	__asm__ __volatile__("pushw	%%es;"
		"int	$0x21;"
		"movw	%%es,%0;"
		"popw	%%es;" : "=r" (out_vec->seg), "=b" (out_vec->ofs)
	  : "a" (0x3500 | vecnum));
}
...
OSKIT_INLINE void i16_dos_set_int_vec(int vecnum, struct far_pointer_16 *new_vec)
{
	__asm__ __volatile__("pushw	%%ds;"
		"movw	%1,%%ds;"
		"int	$0x21;"
		"popw	%%ds;" : : "a" (0x2500 | vecnum), "r" (new_vec->seg), "d" (new_vec->ofs));
}
...
OSKIT_INLINE int i16_dos_open(const char *filename, int access)
{
	...
	__asm__ __volatile__("int	$0x21;"
		"jnc	1f;"
		"movl	$-1,%%eax;"
		"1:" : "=a" (fh) : "a" (0x3d00 | access), "d" (filename));
	return fh;
}

OSKIT_INLINE void i16_dos_close(int fh)
{
	__asm__ __volatile__("int $0x21" : : "a" (0x3e00), "b" (fh));
}
...
OSKIT_INLINE int i16_dos_get_device_info(int fh)
{
	...
	__asm__ __volatile__("int	$0x21;"
		"jnc	1f;"
		"movl	$-1,%%edx;"
		"1:" : "=d" (info_word) : "a" (0x4400), "b" (fh), "d" (0));
	return info_word;
}
...
OSKIT_INLINE unsigned short i16_dos_get_psp_seg(void)
{
	...
	__asm__ __volatile__("int $0x21" : "=b" (psp_seg) : "a" (0x6200));
	return psp_seg;
}
